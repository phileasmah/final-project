...
export default function Home() {
  ...
  return (
    <div className="flex-col">
      ...
      <div className="w-40 m-auto px-2.5 md:px-4 py-2 font-semibold bg-blue-600 rounded text-white duration-200 hover:bg-blue-500 focus:bg-blue-500 hover:rounded-2xl focus:rounded-2xl">
        {session || loading ? (
          <button
            onClick={() => signOut()}
